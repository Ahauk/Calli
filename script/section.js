...
$(document).ready(function() {
  ...
  */
  ...
  On production, 410 number must be .section-heading transform transition time in miliseconds + 10, Or at leats thats whats the demo course says about this effect.
  */
  ...
  $(document).on('click', '.nav-elem:not(.active)', function() {
    ...
    if (Math.abs(activePage - futurePage) > 2) {
      var $fakePage = $('.section-' + futurePage).clone(),
        ...
        fakeNumber = 0;
      // ugly code, i'm not understand yet at all.
